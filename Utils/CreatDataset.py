...
class CreatDataset(Dataset):
    def __init__(self, name, label, data_rootdir, patchsize, traintestflag='train'):
        self.allname = name
        self.alllabel = label
    ...
    def __getitem__(self, item):
        ...
        while patch_np.shape != (self.patchsize, self.patchsize, self.patchsize):
