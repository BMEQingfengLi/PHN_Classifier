...
if __name__ == '__main__':
    ...
    data_rootdir = './DL_trainingdata/'
    origdatarootpth = r'./DataSplit'

    current_pair_list = ['HCOthers']
    for current_pair in current_pair_list:
        ...
        feature_name_suffix_list = ['Stage2FeatureTop10_%s.npy' % current_pair]
        ...
        for fold in [1]:
            ...
            pretrained_modelpth = "PRETRAIN_MODELPTH"
